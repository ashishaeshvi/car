<div class="modal fade" id="mileageModal" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form method="POST" action="{{ route('mileages.store') }}" id="mileageForm" autocomplete="off"
