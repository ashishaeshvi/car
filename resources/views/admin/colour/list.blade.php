        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    ...
                    @can('colour.create')
                    <button type="button" class="btn btn-info"  style="margin-right:3px;float: right;" data-toggle="modal" data-target="#colourModal">
...
@include('admin.colour.modals.add-edit')
@endsection
@section('scripts')
<script src="{{ asset('admin-assets/scripts/colour.js') }}"></script>
<script>
