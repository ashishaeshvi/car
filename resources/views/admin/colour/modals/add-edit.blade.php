<div class="modal fade" id="colourModal" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form method="POST" action="{{ route('colours.store') }}" id="colourForm" autocomplete="off"
