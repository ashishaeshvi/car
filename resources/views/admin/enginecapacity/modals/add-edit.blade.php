<div class="modal fade" id="engineCapacityModal" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form method="POST" action="{{ route('engine-capacities.store') }}" id="engineCapacityForm" autocomplete="off"
