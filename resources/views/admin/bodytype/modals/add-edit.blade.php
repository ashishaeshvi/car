<div class="modal fade" id="bodyTypeModal" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form method="POST" action="{{ route('body-types.store') }}" id="bodyTypeForm" autocomplete="off"
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" class="custom-file-input  preview-image" data-preview="#showImg"
                          id="image" name="image" accept=".png, .jpg, .jpeg" style="cursor: pointer;">
